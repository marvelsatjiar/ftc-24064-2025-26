...
public class FollowerConstants {
    ...
    public static String leftRearMotorName = "left back";
    public static String rightFrontMotorName = "right front";
    public static String rightRearMotorName = "right back";

    // This section is for setting the actual drive vector for the front left wheel, if the robot
    // is facing a heading of 0 radians with the wheel centered at (0,0)
    private static final double xMovement = 86.3401; // 78.8273
    private static final double yMovement = 68.976; // 65.4993
    ...
    // if not negative, then the robot thinks that its going to go faster under 0 power
    // this is for curves
    public static double lateralZeroPowerAcceleration = -30.1;//-62.9961, -91.51952;
